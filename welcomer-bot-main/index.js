...
client.once('ready', async () => {
	...
	console.log('boodyhsn!');
	console.log('discord.gg/boodyhsn');
...
client.on('guildMemberAdd', async member => {
    ...
    const welcomeEmbed = new Discord.MessageEmbed()
        ...
        .addFields(
            ...
            { name: 'Server Rules', value: '<#1111111111>.', inline: true },
            { name: 'Support Channel', value: '<#1111111111>.', inline: true }
        )
    ...
    const row = new MessageActionRow()
        .addComponents(
            new MessageButton()
                .setStyle('LINK')
                .setURL('https://www.youtube.com/channel/UCY2qBGsEbSGceH4VHAEZAUw')       // link to button 1
                .setLabel('YouTube')                                 // name of button 1
                .setEmoji('<:Youtube1:1204939267147571260>'),       // emoji of button 1
            new MessageButton()
        );
